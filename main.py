...
def init_db():
    ...
    # Pre-populate with Monzo promotion if table is empty
    cursor.execute('''
...
def auto_miner_loop():
    """Runs continuously in the background managing the Monzo referral engine."""
    ...
    while True:
        ...
        # Keep engine alive, refreshes every 2 hours
        time.sleep(7200)
